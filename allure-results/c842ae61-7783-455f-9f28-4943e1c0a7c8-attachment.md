    ...
    - generic [ref=e438]:
      - generic [ref=e439]:
        ...
        - generic [ref=e443]:
          ...
          - generic [ref=e445]: All rights reserved © 2025 Info Edge (India) Ltd.
...
> 49 |         await delete_popup.nth(2).click({force:true})
  ...
  61 | 
  62 |     await expect(page.locator(".updateOn.typ-14Regular")).toContainText("Uploaded on Jun 07, 2026")
  63 | 
  64 |     // const icon:Locator = page.getByAltText("naukri user profile img")
  65 |     await icon.click();
  66 | 
  67 |     await page.getByText("Logout").click()
  68 | 
