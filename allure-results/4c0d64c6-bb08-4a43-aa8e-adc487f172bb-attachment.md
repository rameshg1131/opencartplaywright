...
Expected substring: "Uploaded on Jun 11, 2026"
Received string:    "Uploaded on Jun 15, 2026"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.updateOn.typ-14Regular')
    13 × locator resolved to <div class="updateOn typ-14Regular">…</div>
       - unexpected value "Uploaded on Jun 15, 2026"

```

```yaml
- text: Uploaded on Jun 15, 2026
```
...
```ts
  ...
  62 | 
> 63 |     await expect(page.locator(".updateOn.typ-14Regular")).toContainText("Uploaded on Jun 11, 2026")
     |                                                           ^ Error: expect(locator).toContainText(expected) failed
  64 | 
