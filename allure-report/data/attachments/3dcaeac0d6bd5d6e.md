...
Call log:
  - waiting for getByPlaceholder('Enter Email ID / Username')
...
```ts
  ...
  6  | // })
  7  | 
  8  | test("Login to App @sanity",async()=>{
  ...
  13 |     const username:Locator = (await page).getByPlaceholder("Enter Email ID / Username")
> 14 |     await username.fill("ramesh.g1131@gmail.com")
     |                    ^ Error: locator.fill: Target page, context or browser has been closed
  15 |     const password:Locator = (await page).getByLabel("Enter Password")
  16 |     await password.fill("Kush@1807")
  17 |     const showhide:Locator = (await page).locator(".showhide.blue-text")
