...
```
Error: locator.ariaSnapshot: Error: strict mode violation: getByAltText('Naukri Logo') resolved to 2 elements:
    1) <a alt="Naukri Logo" href="https://www.naukri.com" class="nI-gNb-header__logo nI-gNb-company-logo">…</a> aka getByRole('link', { name: 'Naukri Logo' })
    2) <img alt="Naukri Logo" href="https://www.naukri.com" src="https://static.naukimg.com/s/0/0/i/naukri-identity/naukri_gnb_logo.svg"/> aka getByRole('link', { name: 'Naukri Logo' })

Call log:
  - waiting for getByAltText('Naukri Logo')
...
> 12 |     const logo=await page.getByAltText("Naukri Logo").ariaSnapshot()
     |                                                       ^ Error: locator.ariaSnapshot: Error: strict mode violation: getByAltText('Naukri Logo') resolved to 2 elements:
  13 |     console.log(logo)
  14 |     
  15 | })
